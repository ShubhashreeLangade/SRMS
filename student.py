...
class StudentClass:
    def __init__(self, root):
        ...
        # Setting up the headings for each column
        ...
        # Setting up the width for each column
        ...
        # Pack and expand the table
        self.CourseTable.pack(fill=BOTH, expand=1)

        # Bind event to select data
        self.CourseTable.bind("<ButtonRelease-1>", self.get_data)

        # Call method to show data in the table
        self.show()
        ...
        try:
            if self.var_roll.get()=="":
                ...
                if row==None:
                    ...
                    op=messagebox.askyesno("Confirm","Do ypu really want to delete?",parent=self.root)
                    if op==True:
    ...
    def search(self):
        ...
        cur = con.cursor()
        try:
        # Properly format the search term and use parameterized queries to prevent SQL injection
